...
public class PetControl {
	...
	private ObservableList<String> racas = FXCollections.observableArrayList("Bulldog", "Cocker", "Fila",
	...
	public void adicionar(Pet p) {
		...
		if (erros.isEmpty()) {
			petDAO.adicionar(p);
			alert(AlertType.INFORMATION, "Pet Shop", null, "Pet " + p.getNome() + " cadastrado com sucesso");
			pesquisarPorNome("");
		} else {
